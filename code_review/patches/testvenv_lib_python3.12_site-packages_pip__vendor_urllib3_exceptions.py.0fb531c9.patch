--- a/testvenv/lib/python3.12/site-packages/pip/_vendor/urllib3/exceptions.py
+++ b/testvenv/lib/python3.12/site-packages/pip/_vendor/urllib3/exceptions.py
@@ -3,321 +3,203 @@
...
+        super().__init__("%s: %s" % (pool, message))
...
-    pass
-
+    """Body should be :class:`http.client.HTTPResponse` like for read_chunked()."""
+    pass
...
-
+    # TODO: Stop inheriting from AssertionError in v2.0.
     def __init__(self, scheme):

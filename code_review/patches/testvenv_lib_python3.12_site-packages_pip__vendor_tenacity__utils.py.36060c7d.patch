--- a/testvenv/lib/python3.12/site-packages/pip/_vendor/tenacity/_utils.py
+++ b/testvenv/lib/python3.12/site-packages/pip/_vendor/tenacity/_utils.py
@@ -1,53 +1,25 @@

...
$font-normal: -apple-system, BlinkMacSystemFont, "Segoe UI", Roboto, Ubuntu, Cantarell,
	...
	p {
		...
		* {
		...
		.t {
			...
			box-sizing: border-box;
			margin-left: -0.5em;
			padding-left: 0.5em - $border-indicator-width;
			...
			& ~ .r label.ctx {
				...
				&:hover {
					...
					@include background-dark(
						mix($dark-context-bg-color, $dark-bg, $off-button-lighten)
					);
					color: $light-gray5;
					@include color-dark($dark-gray5);
				}

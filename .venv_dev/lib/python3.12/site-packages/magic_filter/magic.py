...
class MagicFilter:
    ...
    def _resolve(
        self, value: Any, operations: Optional[Tuple[BaseOperation, ...]] = None
    ) -> Any:
        initial_value = value
    ...
    def __or__(self: MagicT, other: Any) -> MagicT:
        if isinstance(other, MagicFilter):
            return self._extend(
                ImportantCombinationOperation(right=other, combinator=or_op)
            )
        return self._extend(
            ImportantCombinationOperation(right=other, combinator=operator.or_)
        )
    ...
    def __lshift__(self: MagicT, other: Any) -> MagicT:
        return self._extend(
            CombinationOperation(right=other, combinator=operator.lshift)
        )

    def __rlshift__(self: MagicT, other: Any) -> MagicT:
        return self._extend(
            RCombinationOperation(left=other, combinator=operator.lshift)
        )
    ...
    def __truediv__(self: MagicT, other: Any) -> MagicT:
        return self._extend(
            CombinationOperation(right=other, combinator=operator.truediv)
        )

    def __rtruediv__(self: MagicT, other: Any) -> MagicT:
        return self._extend(
            RCombinationOperation(left=other, combinator=operator.truediv)
        )
    ...
    def __matmul__(self: MagicT, other: Any) -> MagicT:
        return self._extend(
            CombinationOperation(right=other, combinator=operator.matmul)
        )

    def __rmatmul__(self: MagicT, other: Any) -> MagicT:
        return self._extend(
            RCombinationOperation(left=other, combinator=operator.matmul)
        )
    ...
    def func(
        self: MagicT, func: Callable[[Any], Any], *args: Any, **kwargs: Any
    ) -> MagicT:

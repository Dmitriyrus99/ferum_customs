...
class SdistBuilder:
    ...
    def from_ini_path(cls, ini_path: Path):
        ...
        return cls(
            ...
            metadata,
            srcdir,
            ini_info.reqs_by_extra,
            ini_info.entrypoints,
            extra_files,
            ini_info.data_directory,
            ini_info.sdist_include_patterns,
    ...
    def select_files(self):
        ...
        return (
            ...
            + [
                osp.relpath(p, cfgdir_s)
                for p in common.walk_data_dir(self.data_directory)
            ]
            + self.extra_files
        )
